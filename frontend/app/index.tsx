/**
 * Splash Screen — animated landing that auto-redirects.
 */
...
export default function SplashScreen() {
  ...
  useEffect(() => {
    ...
    Animated.timing(slideAnim, { toValue: 0, duration: 600, delay: 400, useNativeDriver: true }).start();
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 36, fontWeight: '800', color: '#FFF', textAlign: 'center', letterSpacing: -1 },
  subtitle: { fontSize: 36, fontWeight: '300', color: 'rgba(255,255,255,0.9)', textAlign: 'center', letterSpacing: 2, marginTop: -4 },
  tagline: { fontSize: 15, color: 'rgba(255,255,255,0.7)', marginTop: 16, letterSpacing: 1 },
